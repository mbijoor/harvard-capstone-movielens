...
\NormalTok{rmse\_results }\OtherTok{\textless{}{-}} \FunctionTok{bind\_rows}\NormalTok{(rmse\_results, }
                          \FunctionTok{tibble}\NormalTok{(}\AttributeTok{Index =} \StringTok{"10"}\NormalTok{, }
                                 \AttributeTok{Method=}\FunctionTok{paste0}\NormalTok{(}\StringTok{"Regularized Movie + User + Genre + Rating Time + Release date Effect Model {-} "}\NormalTok{,k,}\StringTok{" fold CV"}\NormalTok{), }
...
\NormalTok{rmse\_results }\OtherTok{\textless{}{-}} \FunctionTok{bind\_rows}\NormalTok{(rmse\_results, }
                          \FunctionTok{tibble}\NormalTok{(}\AttributeTok{Index =} \StringTok{"VAL"}\NormalTok{, }
                                 \AttributeTok{Method=}\FunctionTok{paste0}\NormalTok{(}\StringTok{"Regularized Movie + User + Genre + Rating Time + Release date Effect Model {-} "}\NormalTok{,k,}\StringTok{" fold CV {-} Validation"}\NormalTok{), }
