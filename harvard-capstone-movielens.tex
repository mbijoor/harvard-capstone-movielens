...
\hypersetup{
  pdftitle={Movielens A Harvard Capstone Project},
...
\usepackage{amsmath} \usepackage{pdflscape}
\usepackage{subfig}
\usepackage{booktabs}
...
following model is most appropriate:

\(Y_{u,i}=\mu+b_{i}+b_{u}+f(d_{u,i})+\epsilon_{u,i}\), with f a smooth
function of \(d_{u,i}\)
