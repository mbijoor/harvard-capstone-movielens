...
#' 
## ----create_edx_val, eval=TRUE, echo=FALSE, warning=FALSE, cache=FALSE, include=FALSE----
...
#' 
## ---- eda_1, include=TRUE, echo=FALSE, message=FALSE--------------------
...
#' 
## ---- eda_2, include=TRUE, echo=FALSE, message=FALSE--------------------
unique_u_m_g <- edx %>% 
...
#' 
## ---- eda_3, include=TRUE, echo=FALSE, message=FALSE--------------------
keep <- edx %>%
  dplyr::count(movieId) %>%
  top_n(4) %>%
  pull(movieId)
...
#' 
## ----eda_4, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.pos="h!", fig.cap="A Very Sparse Matrix\\label{fig:matr}"----
...
#' 
## ---- eda_5, echo=FALSE, eval=TRUE, fig.pos="h!", fig.cap="Movies getting rated distribution\\label{fig:movies_getting_rated}"----
edx %>% 
  dplyr::count(movieId) %>% 
  ggplot(aes(n)) + 
...
#' 
## ---- eda_6, echo=FALSE, eval=TRUE, fig.pos="h!", fig.cap="Users rating movies distribution\\label{fig:users_rating_movies}"----
edx %>%
  dplyr::count(userId) %>% 
  ggplot(aes(n)) + 
  geom_histogram(bins = 30, color = "black") + 
...
#' 
## ---- gnr, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Movies genres error bar plots\\label{fig:genres_error_bar_plots}"----
...
#' 
## ---- rd_1, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Movies average ratings for each week versus day\\label{fig:movies_average_ratings_for_each_week_versus_day}"----
...
#' 
## ---- md_1, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.ncol = 1, out.width= "70%", fig.align = "center", fig.cap="Ratings Movie Release Date - All dates\\label{fig:ratings_movie_release_date_all_dates}", fig.subcap=c('All data points only', 'Smooth line through all data points')----
ratings_m_y <- edx_md %>%
  group_by(movieId) %>%
...
#' 
## ---- md_2, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="25 Movies with the most ratings per year and their average rating post 1993\\label{fig:25_movies_avg_and_most_ratings_per_year_post_1993}"----
...
#' 
#' **Post-1993 movies**   
## ---- md_3, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Movies average ratings versus ratings per year post  1993\\label{fig:movies_average_ratings_versus_ratings_per_year_post_1993}"----
res3 <- edx_md %>%
  filter(movie_dt >= 1993) %>%
  group_by(movieId) %>%
  summarize(avg_rating = mean(rating), n = n(), title=title[1], years=2018 - min(movie_dt)) %>%
...
#' 
## ---- md_4, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Movies average ratings versus ratings per year pre  1993\\label{fig:movies_average_ratings_versus_ratings_per_year_pre_1993}"----
res3_b <- edx_md %>%
  filter(movie_dt < 1993) %>%
  group_by(movieId) %>%
  summarize(avg_rating = mean(rating), n = n(), title=title[1], years=2018 - min(movie_dt)) %>%
...
#' 
#' **_All Years_**
## ---- md_5, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Movies average ratings versus ratings per year for all years for edx\\label{fig:movies_average_ratings_versus_ratings_per_year_for_all_years_for_edx}"----
res3_all_edx <- edx_md %>%
  group_by(movieId) %>%
...
#' 
#' 
## ---- md_6, echo=FALSE, eval=TRUE, comment=""---------------------------
...
#' 
#' **_All Years_**
## ---- md_7, echo=FALSE, eval=TRUE, comment=""---------------------------
...
#' 
## ---- split_edx, echo=FALSE, eval=TRUE, warning=FALSE-------------------
# Sys.time()
set.seed(1, sample.kind="Rounding")
...
#' 
## ---- loss_fn, echo=1:1, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy=TRUE, tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- m_1_1, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy=TRUE----
(mu_hat <- mean(train_set$rating))

#' 
#' If we predict all unknown ratings with $\hat\mu$ we obtain the following RMSE:
#' 
## ---- m_1_2, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy=TRUE----
...
#' 
## ---- m_1_3, echo=1:8,  eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy=TRUE----
...
#' \end{equation}
#' 
## ---- me_1, echo=1:2, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- me_2, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Movie effect or bias distribution\\label{fig:model_2}"----
movie_avgs %>%  
  ggplot(aes(b_i)) + 
...
#' 
## ---- me_3, echo=1:2, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- ue_1, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60), fig.pos="h!", fig.cap="Average rating for users who have rated over 100 movies\\label{fig:average_ratings_for_users_who_have_rated_over_100_movies}"----
train_set %>% 
  group_by(userId) %>% 
...
#' 
## ---- ue_2, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60), fig.pos="h!", fig.cap="Average rating for users who have rated any movies\\label{fig:average_ratings_for_users_who_have_rated_any_movies}"----
train_set %>% 
  group_by(userId) %>% 
  summarize(b_u = mean(rating)) %>% 
  ggplot(aes(b_u)) + 
...
#' 
#' \newpage
## ---- ue_3, echo=1:1, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
user_avgs <- train_set %>% 
  left_join(movie_avgs, by='movieId') %>%
  group_by(userId) %>%
...
#' 
## ---- ue_4, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="User effect or bias distribution\\label{fig:model_3}"----
user_avgs %>%  
  ggplot(aes(b_u)) + 
  geom_histogram(bins = 10, color = "black") + 
  # scale_x_log10() +  # try with and without this line
...
#' 
## ---- ue_5, echo=1:2, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' \end{center}
#' 
## ---- ge_1, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60), fig.pos="h!", fig.cap="Average rating for movies of category genres\\label{fig:average_ratings_for_movies_of_category_genres}"----
train_set %>% 
  group_by(genres) %>% 
...
#' 
## ---- ge_3, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- ge_4, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Genres effect or bias distribution\\label{fig:model_4}"----
genres_avgs %>%  
  ggplot(aes(b_g)) + 
  geom_histogram(bins = 10, color = "black") + 
  # scale_x_log10() +  # try with and without this line
...
#' We can now construct predictors and see how much the RMSE improves:
#' 
## ---- ge_5, echo=1:2, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- rte_1, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' We can see that these estimates vary substantially, see Figure \ref{fig:model_4}
#' 
## ---- rte_2, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Rating time effect or bias distribution\\label{fig:model_5}"----
time_effect_avgs %>%  
  ggplot(aes(b_d)) + 
  geom_histogram(bins = 10, color = "black") + 
  # scale_x_log10() +  # try with and without this line
...
#' We can now construct predictors and see how much the RMSE improves
#' 
## ---- rte_3, echo=1:2, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- rde_1, echo=1:1, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- rde_2, echo=FALSE, eval=TRUE, comment="", fig.pos="h!", fig.cap="Release Date effect or bias distribution\\label{fig:model_6}"----
rel_effect_avgs %>%  
  ggplot(aes(b_r)) + 
  geom_histogram(bins = 10, color = "black") + 
  # scale_x_log10() +  # try with and without this line
...
#' We can now construct predictors and see how much the RMSE improves
#' 
## ---- rde_3, echo=1:3, eval=TRUE, comment=""----------------------------
...
## ---- reg_1, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7',  tidy.opts=list(blank = FALSE, width.cutoff = 60)----
test_set %>% 
  left_join(movie_avgs, by='movieId') %>%
...
#' 
## ---- reg_2, echo=2:2, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
load("rdas/edx.rda")
movie_titles <- edx %>% 
...
#' 
## ---- reg_3, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- reg_4, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
movie_avgs %>% left_join(movie_titles, by="movieId") %>%
  arrange(b_i) %>% 
  slice(1:10)  %>% 
  pull(title)%>% 
...
#' **10 best movies**
#' 
## ---- reg_5, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' **10 worst movies**
#' 
## ---- reg_6, echo=TRUE, eval=TRUE, message=FALSE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
train_set %>% count(movieId) %>% 
...
#' 
## ---- m7_1, echo=TRUE, eval=TRUE, comment=""----------------------------
...
## ---- m7_2, echo=FALSE, eval=TRUE---------------------------------------
rm(just_the_sum)

#' 
#' To see how the estimates shrink, let's make a plot of the regularized estimates versus the least squares estimates.
#' 
## ---- m7_3, echo=FALSE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' **Top 10 best movies**
#' 
## ---- m7_4, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
train_set %>%
  dplyr::count(movieId) %>% 
...
#' **Top 10 worst movies**
#' 
## ---- m7_5, echo=TRUE, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
train_set %>%
  dplyr::count(movieId) %>% 
  left_join(movie_reg_avgs) %>%
  left_join(movie_titles, by="movieId") %>%
...
#' 
## ---- m7_6, echo=1:2, eval=TRUE, collapse = TRUE, comment="", highlight=TRUE, background='#F7F7F7', tidy.opts=list(blank = FALSE, width.cutoff = 60)----
...
#' 
## ---- m8_1, echo=TRUE, eval=TRUE, comment=""----------------------------
lambdas <- seq(0, 10, 0.25)
rmses <- sapply(lambdas, function(l){
  mu <- mean(train_set$rating)
  b_i <- train_set %>%
...
#' 
## ---- m8_2, echo=TRUE, eval=TRUE----------------------------------------
(lambda <- lambdas[which.min(rmses)])

## ---- m8_3, echo=FALSE, eval=TRUE---------------------------------------
...
#' 
## ---- m9_1, echo=TRUE, eval=TRUE, comment=""----------------------------
lambdas <- seq(0, 10, 0.25)
rmses <- sapply(lambdas, function(l){
  mu <- mean(train_set$rating)
  b_i <- train_set %>%
...
#' **_Here we use only 1 fold_**
#' 
## ---- m9_2, echo=FALSE, eval=TRUE, comment=""---------------------------
mu <- mean(train_set$rating)
movie_reg_avgs <- train_set %>%
    group_by(movieId) %>%
    summarize(b_i = sum(rating - mu)/(n()+lambda), n_i = n())
...
#' 
## ---- mf_cv_all_models, echo=TRUE, eval=TRUE, warning=FALSE, comment=""----
Sys.time()
...
#' 
#' We will use the penalty term from our previous section where we got our optimal lambda_opt `r lambda_opt` using `r k`-fold CV to get minimum RMSE for the edx test_set
#' 
## ---- m10_1, echo=TRUE, eval=TRUE, comment=""---------------------------
# load("rdas/train_set.rda")
...
#' \newpage
#' To see how the estimates shrink, let's make a plot of the regularized estimates versus the least squares estimates.
#' **_Here we use_** `r k` **_fold_**
#' 
## ---- m10_2, echo=FALSE, eval=TRUE, comment=""--------------------------
mu <- mean(train_set$rating)
lambda <- lambda_opt
movie_reg_avgs <- train_set %>%
    group_by(movieId) %>%
...
#' 
#' 
## ---- m10_3, echo=FALSE, eval=TRUE, comment=""--------------------------
...
#' 
## ---- final_val_1, echo=TRUE, eval=TRUE, comment=""---------------------
...
#' 
## ---- final_val_2, echo=FALSE, eval=TRUE, comment=""--------------------
...
#' 
## ---- final_val_3, echo=FALSE, eval=TRUE--------------------------------
